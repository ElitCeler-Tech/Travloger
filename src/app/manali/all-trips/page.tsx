...
export default async function ManaliAllTripsPage() {
  const content = await fetchCityContent('manali')
  console.log('ManaliAllTripsPage - Content received:', content);
  console.log('ManaliAllTripsPage - Header content:', content?.header);
  return (
    <>
      <ScrollProgress />
