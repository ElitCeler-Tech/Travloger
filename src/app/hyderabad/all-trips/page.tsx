...
export default async function HyderabadAllTripsPage() {
  const content = await fetchCityContent('hyderabad')
  console.log('HyderabadAllTripsPage - Content received:', content);
  console.log('HyderabadAllTripsPage - Header content:', content?.header);
  return (
    <>
      <ScrollProgress />
