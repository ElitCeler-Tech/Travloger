...
const HyderabadHero = React.memo(({ content }: { content?: HeroContent }) => {
  const prefersReducedMotion = useReducedMotion();

  // WhatsApp contact function
  const handleWhatsAppClick = () => {
    const phoneNumber = (content?.whatsappPhone || '+919876543210').replace(/\s+/g, '');
    const message = encodeURIComponent(content?.whatsappMessage || 'Hi! I am interested in Hyderabad tour packages. Can you help me plan my trip?');
        ...
        {content?.mobileVideoUrl ? (
          ...
          >
            ...
            <Image
              ...
              alt={content?.title || 'Hyderabad landscape with Charminar and Golconda Fort'}
              fill
          ...
          >
            ...
            >
              <motion.button
                ...
                aria-label="Contact us on WhatsApp to plan your Hyderabad trip"
              >
              ...
              <motion.button
                ...
                whileHover={prefersReducedMotion ? {} : { scale: 1.05 }}
                whileTap={prefersReducedMotion ? {} : { scale: 0.95 }}
                aria-label="View our Hyderabad tour packages and itineraries"
              >
...
HyderabadHero.displayName = 'HyderabadHero';

export default HyderabadHero;
