          ...
          <div className="text-center mb-8 md:mb-12">
            <h2 className={cn(
              ...
              {content?.heading ? (
                ...
                <>
                  How Do You Want To{' '}
                  <span className="relative text-[#134956]">Explore Ladakh<span className="absolute left-0 right-0 bottom-0 h-[6px] bg-[#134956]/20 rounded-full -z-10 translate-y-[-2px] skew-x-[-2deg]" /></span>?
                </>
              )}
            </h2>
