...
const manaliFaqData: FAQType[] = [
  {
    id: '1',
    question: "What's included in the Travlogers Manali package?",
    answer: "Our Manali package includes hotel stays, daily breakfast & dinner, private cab for sightseeing, and photography. Adventure activities, trekking, and special experiences can be added as extras. You'll also get 24/7 trip support from our team."
  },
  {
    id: '2',
    question: "Is photography included in the group trip?",
    answer: "Yes, professional photography is included in all our Manali group trips. Our experienced photographers will capture your best moments throughout the journey, including stunning mountain views, adventure activities, and cultural experiences, and you'll receive a curated collection of high-quality photos after the trip."
  },
  {
    id: '3',
    question: "How does the booking process work?",
    answer: "The booking process is simple: 1) Choose your preferred Manali package and dates, 2) Pay a small booking amount to secure your spot, 3) Complete the remaining payment before the trip, 4) Receive your detailed itinerary and travel documents. Our team will guide you through each step."
  },
  {
    id: '4',
    question: "Will someone assist us during the trip?",
    answer: "Absolutely! You'll have a dedicated trip coordinator who will be available 24/7 throughout your Manali journey. Additionally, our local guides will accompany you to all major attractions and provide insights about Manali's culture, history, and hidden gems."
  },
  {
    id: '5',
    question: "Do you arrange adventure activities or surprises for couples?",
    answer: "Yes, we specialize in creating magical experiences in Manali! We can arrange adventure activities like paragliding, skiing, trekking, and river rafting. For couples, we offer romantic surprises like candlelight dinners with mountain views, private hot spring experiences, and special photography sessions at scenic locations like Solang Valley and Rohtang Pass."
  }
];
...
const ManaliFAQ = ({ content }: { content?: FAQContent }) => {
  ...
  return (
    <section className="faq-section relative py-16 lg:py-24 overflow-hidden font-body">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {(content?.items && content.items.length > 0 ? content.items : manaliFaqData).map((faq, index) => {
