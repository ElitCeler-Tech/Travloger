...
const ManaliHero = React.memo(({ content }: { content?: HeroContent }) => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = encodeURIComponent(content?.whatsappMessage || 'Hi! I am interested in Manali tour packages. Can you help me plan my trip?');
        ...
        {content?.mobileVideoUrl ? (
          ...
          >
            ...
            <Image
              ...
              alt={content?.title || 'Manali landscape with snow-capped mountains and valleys'}
              fill
          ...
          >
            ...
            >
              <motion.button
                ...
                aria-label="Contact us on WhatsApp to plan your Manali trip"
              >
              ...
              <motion.button
                ...
                whileHover={prefersReducedMotion ? {} : { scale: 1.05 }}
                whileTap={prefersReducedMotion ? {} : { scale: 0.95 }}
                aria-label="View our Manali tour packages and itineraries"
              >
