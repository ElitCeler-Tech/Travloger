          ...
          <div className="text-center mb-8 md:mb-12">
            <h2 className={cn(
              ...
              {content?.heading ? (
                ...
                <>
                  How Do You Want To{' '}
                  <span className="relative text-[#134956]">Explore Singapore<span className="absolute left-0 right-0 -bottom-1 h-[8px] bg-[#134956]/30 rounded-full skew-x-[-2deg]" /></span>?
                </>
              )}
            </h2>
