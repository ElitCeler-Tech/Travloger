...
const defaultSingaporeContent: HeroContent = {
  title: "Two Ways To Explore Singapore",
  subtitle: "One Story to Remember.",
  backgroundImageUrl: '/hero-bg.png',
  whatsappPhone: '+919876543210',
  whatsappMessage: 'Hi! I am interested in Singapore tour packages. Can you help me plan my trip?',
...
const SingaporeHero = React.memo(({ content }: { content?: HeroContent }) => {
  return <Hero content={content} defaultContent={defaultSingaporeContent} />;
});
