...
const HyderabadTripOptions = React.memo(({ content }: { content?: TripOptionsContent }) => {
  ...
  const customTrips = content?.customTrips || hyderabadTrips.filter(trip => trip.category === 'custom');
  const groupTrips = content?.groupTrips || hyderabadTrips.filter(trip => trip.category === 'group');
          ...
          <div className="text-center mb-8 md:mb-12">
            <h2 className={cn(
              ...
              {content?.heading ? (
                ...
                <>
                  How Do You Want To{' '}
                  <span className="text-[#134956]">Explore Hyderabad</span>?
                </>
              )}
            </h2>
            {content?.subheading && (
