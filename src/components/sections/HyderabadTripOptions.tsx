...
const hyderabadTrips: TripCard[] = [
  // Custom Trips (10)
  {
    ...
    description: 'Explore the rich history of Hyderabad through its magnificent monuments and palaces',
    image: '/cards/1.jpg',
    nights: 3,
    days: 4,
    price: 12999,
    category: 'custom',
    route: 'Charminar → Golconda Fort → Chowmahalla Palace',
    trending: true,
    detailedItinerary: {
      subtitle: 'Complete Heritage Experience',
      briefItinerary: [
        {
          day: 1,
          title: 'Hyderabad Arrival & Charminar',
          description: 'Arrive in Hyderabad and explore the iconic Charminar and surrounding bazaars'
        },
        {
          day: 2,
          title: 'Golconda Fort & Qutub Shahi Tombs',
          description: 'Visit the magnificent Golconda Fort and the royal Qutub Shahi Tombs'
        },
        {
          day: 3,
          title: 'Chowmahalla Palace & Salar Jung Museum',
          description: 'Explore the royal Chowmahalla Palace and the fascinating Salar Jung Museum'
        },
        {
          day: 4,
          title: 'Hussain Sagar Lake & Departure',
          description: 'Visit the beautiful Hussain Sagar Lake and Buddha statue before departure'
        }
      ],
      keyAttractions: [
        'Charminar - Iconic monument of Hyderabad',
        'Golconda Fort - Ancient fortress with amazing acoustics',
        'Chowmahalla Palace - Royal residence of Nizams',
        'Salar Jung Museum - World-class art collection',
        'Hussain Sagar Lake - Heart of the city',
        'Qutub Shahi Tombs - Royal necropolis'
      ],
  ...
  },
  {
    ...
    description: 'Savor the authentic flavors of Hyderabadi cuisine and street food',
    image: '/cards/2.jpg',
    nights: 2,
    days: 3,
    price: 8999,
    category: 'custom',
    route: 'Biryani → Haleem → Street Food → Traditional Sweets'
  },
  {
    id: 'custom-3',
    title: 'Hyderabad IT Hub Experience',
    description: 'Discover the modern side of Hyderabad with its tech parks and innovation centers',
    image: '/cards/3.jpg',
    nights: 2,
    days: 3,
    price: 10999,
    category: 'custom',
    route: 'HITEC City → Cyberabad → Innovation Centers'
  },
  {
    id: 'custom-4',
    title: 'Complete Hyderabad Experience',
    description: 'Comprehensive Hyderabad tour covering heritage, culture, and modern attractions',
    image: '/cards/1.jpg',
    nights: 4,
    days: 5,
    price: 18999,
    category: 'custom',
    route: 'Heritage → Culture → Food → Modern Hyderabad'
  },
  {
    id: 'custom-5',
    title: 'Hyderabad Shopping Spree',
    description: 'Shop for pearls, handicrafts, and traditional items in Hyderabad\'s famous markets',
    image: '/cards/2.jpg',
    nights: 2,
    days: 3,
    price: 9999,
    category: 'custom',
    route: 'Laad Bazaar → Pearls → Handicrafts → Traditional Markets'
  },
  {
    id: 'custom-6',
    title: 'Hyderabad Photography Tour',
    description: 'Capture the beauty of Hyderabad through its monuments, markets, and landscapes',
    image: '/cards/3.jpg',
    nights: 3,
    days: 4,
    price: 14999,
    category: 'custom',
    route: 'Monuments → Markets → Lakes → Architecture'
  },
  {
    id: 'custom-7',
    title: 'Hyderabad Cultural Immersion',
    description: 'Experience the rich culture and traditions of Hyderabad',
    image: '/cards/1.jpg',
    nights: 3,
    days: 4,
    price: 13999,
    category: 'custom',
    route: 'Museums → Art Galleries → Cultural Centers → Traditional Arts'
  },
  {
    id: 'custom-8',
    title: 'Hyderabad Luxury Experience',
    description: 'Premium Hyderabad tour with luxury accommodations and exclusive experiences',
    image: '/cards/2.jpg',
    nights: 4,
    days: 5,
    price: 29999,
  ...
  {
    id: 'custom-9',
    title: 'Hyderabad Weekend Getaway',
    description: 'Perfect weekend escape to explore the best of Hyderabad',
    image: '/cards/3.jpg',
    nights: 2,
    days: 3,
    price: 11999,
    category: 'custom',
    route: 'Heritage → Food → Shopping → Relaxation'
  },
  {
    id: 'custom-10',
    title: 'Hyderabad Business & Pleasure',
    description: 'Combine business meetings with leisure activities in Hyderabad',
    image: '/cards/1.jpg',
    nights: 3,
    days: 4,
    price: 16999,
    category: 'custom',
    route: 'Business Centers → Heritage → Networking → Cultural Events'
  },
  // Group Departures (8)
  {
    id: 'group-1',
    title: 'Hyderabad Group Heritage Tour',
    description: 'Join fellow travelers for an unforgettable Hyderabad heritage experience',
    image: '/cards/1.jpg',
    nights: 3,
    days: 4,
    price: 11999,
    category: 'group',
    route: 'Charminar → Golconda → Palaces → Museums'
  },
  {
    id: 'group-2',
    title: 'Hyderabad Food Group Tour',
    description: 'Group exploration of Hyderabad\'s famous cuisine and culinary traditions',
    image: '/cards/2.jpg',
    nights: 2,
    days: 3,
    price: 8999,
    category: 'group',
    route: 'Biryani → Haleem → Street Food → Traditional Cuisine'
  },
  {
    id: 'group-3',
    title: 'Hyderabad Cultural Group Tour',
    description: 'Group cultural immersion in Hyderabad\'s rich traditions and heritage',
    image: '/cards/3.jpg',
    nights: 3,
    days: 4,
    price: 12999,
  ...
  {
    id: 'group-4',
    title: 'Hyderabad Photography Group Tour',
    description: 'Photography-focused group tour capturing Hyderabad\'s stunning architecture',
    image: '/cards/1.jpg',
    nights: 3,
    days: 4,
    price: 13999,
    category: 'group',
    route: 'Monuments → Markets → Architecture → Cultural Photography'
  },
  {
    id: 'group-5',
    title: 'Hyderabad Shopping Group Tour',
    description: 'Group shopping experience in Hyderabad\'s famous markets and bazaars',
    image: '/cards/2.jpg',
    nights: 2,
    days: 3,
    price: 9999,
    category: 'group',
    route: 'Pearls → Handicrafts → Traditional Markets → Shopping Districts'
  },
  {
    id: 'group-6',
    title: 'Hyderabad Weekend Group Tour',
    description: 'Group weekend getaway exploring the best of Hyderabad',
    image: '/cards/3.jpg',
    nights: 2,
    days: 3,
    price: 10999,
  ...
  {
    id: 'group-7',
    title: 'Hyderabad Modern Group Tour',
    description: 'Group exploration of modern Hyderabad including IT hubs and innovation centers',
    image: '/cards/1.jpg',
    nights: 2,
    days: 3,
    price: 11999,
    category: 'group',
    route: 'HITEC City → Cyberabad → Innovation Centers → Modern Attractions'
  },
  {
    id: 'group-8',
    title: 'Hyderabad Complete Group Tour',
    description: 'Comprehensive group tour covering all aspects of Hyderabad',
    image: '/cards/2.jpg',
    nights: 4,
    days: 5,
    price: 17999,
    category: 'group',
    route: 'Heritage → Culture → Food → Modern → Shopping'
  }
];
...
const HyderabadTripOptions = React.memo(({ content }: { content?: TripOptionsContent }) => {
  ...
  const { packages: customTrips } = usePackages({ tripType: 'custom', destination: 'Hyderabad' });
  const { packages: groupTrips } = usePackages({ tripType: 'group', destination: 'Hyderabad' });
          ...
          <div className="text-center mb-8 md:mb-12">
            <h2 className={cn(
              ...
              {content?.heading ? (
                ...
                <>
                  How Do You Want To{' '}
                  <span className="relative text-[#134956]">Explore Hyderabad<span className="absolute left-0 right-0 -bottom-2 h-[18px] w-full" style={{backgroundImage: "url(/brush-underline.svg)", backgroundSize: "100% 100%", backgroundRepeat: "no-repeat"}} /></span>?
                </>
              )}
            </h2>
            {content?.subheading && (
...
HyderabadTripOptions.displayName = 'HyderabadTripOptions';

export default HyderabadTripOptions;
