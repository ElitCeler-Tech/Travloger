            ...
            >
              ...
              >
                <div className="p-4">
                  ...
                  {/* Inclusions */}
                  {trip.detailedItinerary?.showInclusions !== false && trip.detailedItinerary?.inclusions && trip.detailedItinerary.inclusions.length > 0 && (
                    <div className="">
                      <div className="mb-2">
                        <h3 className="text-xl font-bold text-gray-900 font-heading">What&apos;s <span className='text-[#134956]'>Included</span></h3>
                      </div>
                      <div className="grid grid-cols-2 gap-2">
                        {trip.detailedItinerary.inclusions.map((item, index) => (
